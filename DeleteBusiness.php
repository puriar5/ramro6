...
if(isset($_POST["Submit"])){
	...
	global $ConnectingDB;
	$Query="DELETE FROM business WHERE id = '$DeleteId'";
	$Execute=mysql_query($Query);
	if($Execute){
		$_SESSION["SuccessMessage"]="Business Information Deleted Successfully";
		Redirect_to("Dashboard.php");
	}else{
		$_SESSION["ErrorMessage"]="Business Information Delete Failed to Add";
		Redirect_to("Dashboard.php");
	}
}
...
<title>Delete Business Information</title>
...
<body>
	...
	<div class="container-fluid"> <!--Main Container-->
		...
		<div class="col-sm-10">
				<h1>Delete Business Information</h1>
				<div>
					<?php 
					echo Message();
					echo SuccessMessage();
				...
				<div>
					...
					?>
				<form action="DeleteBusiness.php?Delete=<?php echo $SearchQueryParameter;?>" method="post" enctype="multipart/form-data">
					<fieldset>
						<div class="form-group">
							<label for="Businessname"><span class="FieldInfo">Business Name:</span></label>
							<input disabled value="<?php echo $Businessname;?>" class="form-control" type="text" name="Businessname" id="Businessname" placeholder="Business Name">
						</div>
						<div class="form-group">
							...
							<input disabled value="<?php echo $Address1;?>"  class="form-control" type="text" name="Address1" id="Address1" placeholder="Business Address Line 1">
						</div>
						<div class="form-group">
							<label for="Address2"><span class="FieldInfo">Address Line 2:</span></label>
							<input disabled value="<?php echo $Address2;?>" class="form-control" type="text" name="Address2" id="Address2" placeholder="Business Address Line 2">
						</div>
						<div class="form-row" style="margin-left: -15px;">
    			 			<div class="form-group col-md-6">
							<label for="TownCity"><span class="FieldInfo">Town or City:</span></label>
      						<input disabled value="<?php echo $TownCity;?>"  type="text" class="form-control" name="TownCity" id="TownCity" placeholder="Town or City">
    						</div>
							<div class="form-group col-md-6">
							<label for="Postcode"><span class="FieldInfo">Postcode:</span></label>
      						<input disabled value="<?php echo $Postcode;?>"  type="text" class="form-control" name="Postcode" id="Postcode" placeholder="Postcode">
    						</div>
						</div>
						<div class="form-group">
							<label for="Phone"><span class="FieldInfo">Phone:</span></label>
							<input disabled value="<?php echo $Phone;?>"  class="form-control" type="text" name="Phone" id="Phone" placeholder="Business Phone Number">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input disabled value="<?php echo $Website;?>"  class="form-control" type="text" name="Website" id="Website" placeholder="Website">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea disabled class="form-control" name="Overview" id="Overviewarea" placeholder="Provide Some Information About Your Business"><?php echo $Overview;?></textarea>
						</div>
						<input class="btn btn-success btn-block" type="submit" name="Submit" value="Delete Business Information">
						<br><br>
					</fieldset>
				</form>
				</div>
