...
<body>
	...
	<div class="container-fluid"> <!--Main Container-->
		...
		<div class="col-sm-2">
				...
				<li class="active"><a href="Gallery.php"><span class="glyphicon glyphicon-equalizer"></span>&nbsp; Gallery</a></li>
				<li><a href="Logout.php"><span class="glyphicon glyphicon-log-out"></span>&nbsp; Logout</a></li>
				</ul>
			</div><!-- Ending of Side Area--->
		<div class="col-sm-10">
				<h1>Upload Images for Business Gallery</h1>
				<div>
					<?php 
					echo Message();
					echo SuccessMessage();
				...
				<tr>
					...
					<td>
						<a href="UploadImage.php?Upload=<?php echo $Id; ?>">
							<span class="btn btn-warning">Upload Images</span></a>  
